"""
Flask server for Student Interaction Form.
"""
import os
import sys
import json
...
DATA_FILE = str(BASE_DIR / 'student_interactions.json')
...
def list_students():
    ...
    return render_template('data-view-frontend.html', students=students)

if __name__ == '__main__':
    if not os.path.exists(DATA_FILE):
        save_student_data([])
        
    print("Starting Student Form Backend. Access at: http://127.0.0.1:5001/student_form")
    print("View submitted forms at: http://127.0.0.1:5001/student_list")
